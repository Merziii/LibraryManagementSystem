...
Public Class ucBorrowLibrarian

    Private selectedStudentID As Integer = 0
    Private selectedBookID As Integer = 0

    Private Sub ucBorrowLibrarian_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnBorrow_Click(sender As Object, e As EventArgs) Handles btnBorrow.Click
        If selectedStudentID = 0 Then
            MsgBox("Please find a student first.", MsgBoxStyle.Exclamation, "Validation")
            Exit Sub
        End If
        ...
        If confirm = MsgBoxResult.Yes Then
            Try
                ...
                cmd = New MySqlCommand(sql, cn)
                cmd.Parameters.AddWithValue("@uid", selectedStudentID)
